...
const SubQuestionDiagramComponent = (props) => {
	...
	return (
		<div className="problem-subdiagram-card">
			<div className="problem-subdiagram-card__header">
				<p className="problem-subdiagram-card__eyebrow">Progress Map</p>
				<h3 className="problem-subdiagram-card__title">
					Track this estimation path
				</h3>
			</div>
			<svg
				className="problem-subdiagram"
				height="100%"
				id="Layer_1"
				version="1.1"
