  ...
  useEffect(() => {
    ...
    const fetchQuestionFiles = async () => {
      try {
        ...
        const res = await fetch(`${apiurl}/question/main?questionId=${questionId}`, {
          headers: {
        ...
        if (data.question.image) {
          if (data.question.image.startsWith('media/images')) {
            ...
            setSelectedImageURL(`${apiurl}/media/images/${data.question.image}`);
          }
        }
      ...
      <div className="container">
        ...
        {selectedPDFURL && (
          <div className="section" style={{paddingLeft:40}}>
            ...
            <embed src={selectedPDFURL} type="application/pdf"  width="250%" height="600px" />
          </div>
        )}
        ...
        {selectedImageURL && (
          <div className="section">
            <p className="heading" style={{paddingBottom:30,paddingLeft:40}}>QUESTION IMAGE:</p>
            <img src={selectedImageURL} alt="Question" className="image" />
          </div>
        )}
      </div>
    </>
